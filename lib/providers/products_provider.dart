...
class Products with ChangeNotifier {
  ...
  List<Product> get items {
    ...
    return [
      ..._items
    ]; //we are copying it _items because passing it somewhere will cause an edit here as the address is passed
  }
  ...
  Future<void> deleteProduct(String id) async {
    final url =
        Uri.parse('https://flutter-update.firebaseio.com/products/$id.json');
